...
exports.link = exports.check = exports.answer = exports.start = exports.Control = void 0;
...
var Control = /*#__PURE__*/function () {
  ...
  _createClass(Control, [{
    ...
    value: function get_text() {
      var parent = document.getElementById('results'); //Не типизируем, потому что делаем проверку

      if (!(parent instanceof HTMLElement)) return;
      var i = 0,
          arr = [],
          word = this.text.textContent,
          newWord = word;
      if (!word) return;
      if (!newWord) return;
      ...
      if (word.slice(-1) > 'а' && word.slice(-1) < 'я') {
        ...
        while (i--) {
          if (arr2[i].checked) {
            var ltg = document.getElementsByTagName('label');
            if (!(ltg instanceof HTMLElement)) return;
            var tmp = ltg[i].textContent;
            if (!tmp) return;
  ...
  _createClass(check, [{
    ...
    value: function nextQuestion() {
      if (this.x1 < 10) {
        ...
        if (!(ain instanceof HTMLElement)) return;
        new answer(ain, _pid);
      }
    }
  }]);
...
function main() {
  ...
  var piid = document.getElementById('play_input');
  if (!(anid instanceof HTMLElement)) return;
  if (!(piid instanceof HTMLElement)) return;
  new _main.answer(anid, piid);
  var biid = document.getElementById('play_input');
  if (!(biid instanceof HTMLElement)) return;
  new _main.check(biid);
  var mid = document.getElementById('main_button');
  var miid = document.getElementById('main_input');
  var rid = document.getElementById('results');
  var fid = document.getElementById('filter_button');
  if (!(mid instanceof HTMLElement)) return;
  if (!(miid instanceof HTMLElement)) return;
  if (!(rid instanceof HTMLElement)) return;
  if (!(fid instanceof HTMLElement)) return;
  new _main.Control(mid, miid, rid);
  new _main.Control(fid, miid, rid);
}

main();
},{"./main.ts":"main.ts"}],"C:/Users/tmclr/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60727" + '/');
...
},{}]},{},["C:/Users/tmclr/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
//# sourceMappingURL=/Vagabulary.77de5100.js.map